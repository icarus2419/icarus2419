...
| **Secure-document-approval** *(private repo)* | Secure document approval system with role-based reviews, file uploads, **SHA-256 evidence tracking**, and audit trails | `Full-Stack` `Security` |
...
<!-- These cards are generated daily by .github/workflows/update-stats.yml
     and served from this repo, so they never rate-limit or break. -->
